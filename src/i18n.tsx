...
const en: Translations = {
  ...
  'askQuestion.disabledNotice' : 'Questions can only be submitted when more than 10 days remain.',
  ...
  'filters.status.infructueux': 'Infructueux',
...
"rh.infructueuxInfodetails": "This offer did not result in a hire. No candidates were selected after evaluating the applications or no applications were received within the deadline.",
"rh.infructueuxDisplay.title" : "Offer Status",
"rh.infructueuxDisplay.label" : "Unsuccessful Offer",// Swal alert translations
  ...
  'rh.status.infructueux': 'Infructueux',
  ...
  'rh.swal.infructueuxTitle': 'Mark as Infructueux',
  'rh.swal.infructueuxConfirmation': 'Are you sure you want to mark this offer as infructueux? This means no applications were received.',
  'rh.swal.infructueuxConfirm': 'Yes, mark as infructueux',
  'rh.swal.infructueuxCancel': 'Cancel',
  'rh.swal.infructueuxCompleteTitle': 'Marked as Infructueux!',
  'rh.swal.great': 'Great!',
  ...
  'askQuestion.nameLabel': 'Your Name',
  'askQuestion.namePlaceholder': 'Enter your name (optional)',
  'askQuestion.nameHelp': 'Providing your name helps us provide more personalized responses.',
  ...
  'rh.button.setInfructueux': 'Mark as Infructueux',
  'rh.button.infructueuxDisabled': 'Offer still active - cannot mark as infructueux',
  'rh.button.infructueuxSuccess': 'Offer marked as infructueux successfully',
  'rh.button.edit': 'Edit',
...
const fr: Translations = {
  ...
  'home.section.subtitle': "Aidez-nous à construire un avenir résilient et durable pour les zones d'Afrique.",
  ...
  'rh.candidateInfodetails': ' À l’issue du processus de sélection, {candidate} a été retenu·e pour ce poste. Nous remercions sincèrement l’ensemble des candidat·es pour leur intérêt et leur participation, et leur souhaitons beaucoup de succès dans la suite de leurs parcours professionnels.',
    "home.alltypes": "Tous types",
"rh.infructueuxInfo": "Cette offre n'a pas abouti",
"rh.infructueuxInfodetails": "Cette offre n'a pas abouti. Aucun candidat n'a été retenu suite à l'évaluation des dossiers ou aucune candidature n'a été reçue dans les délais impartis.",
"rh.infructueuxDisplay.title" : "Statut de l'offre",
"rh.infructueuxDisplay.label" : "Offre infructueuse",// Swal alert translations
  ...
  'rh.swal.infructueuxTitle': 'Marquer comme Infructueux',
  'rh.swal.infructueuxConfirmation': 'Êtes-vous sûr de vouloir marquer cette offre comme infructueuse ? Cela signifie qu\'aucune candidature n\'a été reçue.',
  'rh.swal.infructueuxConfirm': 'Oui, marquer comme infructueux',
  'rh.swal.infructueuxCancel': 'Annuler',
  'rh.swal.infructueuxCompleteTitle': 'Marqué comme Infructueux !',
  ...
  'askQuestion.nameLabel': 'Votre Nom',
  'askQuestion.namePlaceholder': 'Entrez votre nom (optionnel)',
  'askQuestion.nameHelp': 'Fournir votre nom nous aide à fournir des réponses plus personnalisées.',
  ...
  'rh.button.setInfructueux': 'Marquer comme Infructueux',
  'rh.button.infructueuxDisabled': 'Offre toujours active - ne peut pas être marquée comme infructueuse',
  'rh.button.infructueuxSuccess': 'Offre marquée comme infructueuse avec succès',
